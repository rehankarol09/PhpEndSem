...
echo "<tr >";
echo "<td colspan='2' align='center'><h3>EMPLOYEE DETAILS</h3></td>";
echo "</tr>";
echo "<tr>";
...
echo "<tr>";
echo "<td><b>3</b></td>";
echo "<td><b>Graduation</b></td>";
echo "<td><b>" .$_POST['Graduation_Board']  ."</b></td>";
echo "<td><b>" .$_POST['Graduation_Percentage']. "</b></td>";
echo "<td><b>" .$_POST['Graduation_YrOfPassing']. "</b></td>";
echo "</tr>";

echo "<tr>";
echo "<td><b>4</b></td>";
echo "<td><b>Masters</b></td>";
echo "<td><b>" .$_POST['Masters_Board']  ."</b></td>";
echo "<td><b>" .$_POST['Masters_Percentage']. "</b></td>";
echo "<td><b>" .$_POST['Masters_YrOfPassing']. "</b></td>";
echo "</tr>";
